...
parser.add_argument('--seed', type=int, default=9, help="random seed")#217 218 228 #234zyydata  219 220 221 223,224 235yqdata
parser.add_argument('--source_epoch', type=int, default=100, help="sourece epoch")
parser.add_argument('--traget_epoch', type=int, default=10, help="traget epoch")
...
for k in range(10):
    ...
    for i in source_domain:
        ...
        Shot_1 = shot(args, source=i, target='A',globalF_parameters=globalF_parameters,k = k)
        # args.output_dir = osp.join(args.output, 'seed' + str(args.seed) + '{}'.format(i))
