...
parser.add_argument('-bp', '--base-path', default="/root/tf-logs/KD3A-master/dataset/HARdata")
parser.add_argument('--target-domain', default='4',type=str, help="The target domain we want to perform domain adaptation")
parser.add_argument('--source-domains',default='',type=str, nargs="+", help="The source domains we want to use")
...
parser.add_argument('-p', '--print-freq', default=10, type=int,
                    metavar='N', help='print frequency (default: 10)')  #通讯次数
