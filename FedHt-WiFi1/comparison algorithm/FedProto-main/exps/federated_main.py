...
def FedProto_taskheter(args, train_dataset, test_dataset, user_groups, user_groups_lt, local_model_list, classes_list):
    summary_writer = SummaryWriter('/home/yq/FedProto-main/tensorboard/'+ args.dataset +'_fedproto_' + str(args.ways) + 'w' + str(args.shots) + 's' + str(args.stdev) + 'e_' + str(args.num_users) + 'u_' + str(args.rounds) + 'r')

    global_protos = []
    idxs_users = np.arange(args.num_users)
    # print('nihappppppppppppppppp',user_groups)
    ...
    for round in tqdm(range(args.rounds)):
        ...
        for idx in idxs_users:
            ...
            # print('ddddddddddddd',user_groups[idx])
            w, loss, acc, protos = local_model.update_weights_het(args, idx, global_protos, model=copy.deepcopy(local_model_list[idx]), global_round=round)#idx s keygenghuan d
        ...
        acc_list_l, acc_list_g, loss_list = test_inference_new_het_lt(args, local_model_list, test_dataset,
...
if __name__ == '__main__':
    ...
    # print('aaaaaa',n_list,k_list)
    # print('asdasdasd',train_dataset)
    # aaaaaaa
    # aaaaaaaaaaaa
